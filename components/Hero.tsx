...
export default function Hero() {
  return (
    ...
    >
      ...
      {/* --- 1. BACKGROUND IMAGE (FIX ZOOM PROBLEM) --- */}
      {/* Kita gunakan Next Image dengan layout fill agar responsif sempurna */}
      <div className="absolute inset-0 z-0">
        <Image 
          src="https://images.unsplash.com/photo-1519741497674-611481863552?q=80&w=2070&auto=format&fit=crop"
          alt="Wedding Background"
          fill
          className="object-cover object-center" // object-cover memastikan gambar tidak gepeng
          priority // Memuat gambar lebih cepat (LCP)
          sizes="100vw"
        />
        {/* Layer Gradient Gelap di atas gambar */}
        <div className="absolute inset-0 bg-linear-to-r from-black/90 via-black/60 to-black/30"></div>
      </div>

      
      {/* --- 2. KONTEN (Layer z-10 agar di atas gambar) --- */}
