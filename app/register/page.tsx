...
// --- DATA TESTIMONI (Sama dengan Login agar konsisten) ---
const testimonials = [
  {
    id: 1,
    name: "Sarah & Dimas",
        ...
        <div className="max-w-[400px] w-full animate-fade-in-up">
            ...
            <form className="space-y-4">
                ...
                <div className="flex items-start gap-3 py-2">
                    <input type="checkbox" className="mt-1 w-4 h-4 text-pink-600 border-gray-300 rounded focus:ring-pink-500 cursor-pointer" />
                ...
                <button type="button" className="w-full bg-pink-600 text-white font-bold py-4 rounded-xl hover:bg-pink-700 active:scale-95 transition-all shadow-[0_10px_20px_-10px_rgba(219,39,119,0.5)] mt-2">
                    Daftar Sekarang
                </button>
            </form>
