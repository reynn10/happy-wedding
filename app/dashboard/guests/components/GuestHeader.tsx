    ...
    <div className="flex flex-col md:flex-row justify-between items-end gap-6 print:hidden">
      ...
      <div className="flex flex-wrap gap-3">
          {selectedCount > 0 && (
            <button 
              onClick={onBulkSend}
              className="px-5 py-2.5 bg-green-600 text-white rounded-full text-sm font-bold hover:bg-green-700 transition shadow-lg flex items-center gap-2 animate-bounce-slow"
            >
          ...
          <button 
            onClick={onImport}
            className="px-5 py-2.5 bg-blue-50 border border-blue-200 text-blue-700 rounded-full text-sm font-bold hover:bg-blue-100 transition shadow-sm flex items-center gap-2"
          >
